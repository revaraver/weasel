...
!define WEASEL_ROOT $INSTDIR\revar-input-${WEASEL_VERSION}
!define REG_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\ReVarInput"

; The name of the installer
Name "ReVar 输入法 ${WEASEL_VERSION}"

; The file to write
OutFile "archives\revar-input-${PRODUCT_VERSION}-installer.exe"

VIProductVersion "${WEASEL_VERSION}.${WEASEL_BUILD}"
VIAddVersionKey /LANG=2052 "ProductName" "ReVar 输入法"
...
VIAddVersionKey /LANG=2052 "FileDescription" "ReVar 输入法"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "ReVar 輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【ReVar】說明書"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【ReVar】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【ReVar】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【ReVar】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【ReVar】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "ReVar算法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【ReVar】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【ReVar】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【ReVar】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【ReVar】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載ReVar"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的ReVar。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
...
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "ReVar 输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【ReVar】说明书"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【ReVar】输入法设定"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【ReVar】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【ReVar】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【ReVar】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "ReVar算法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【ReVar】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【ReVar】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【ReVar】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【ReVar】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载ReVar"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的ReVar。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
...
LangString DISPLAYNAME ${LANG_ENGLISH} "ReVar Input"
LangString LNKFORMANUAL ${LANG_ENGLISH} "ReVar Manual"
LangString LNKFORSETTING ${LANG_ENGLISH} "ReVar Settings"
LangString LNKFORDICT ${LANG_ENGLISH} "ReVar Dictionary Manager"
LangString LNKFORSYNC ${LANG_ENGLISH} "ReVar Sync User Profile"
LangString LNKFORDEPLOY ${LANG_ENGLISH} "ReVar Deploy"
LangString LNKFORSERVER ${LANG_ENGLISH} "ReVar Server"
LangString LNKFORUSERFOLDER ${LANG_ENGLISH} "ReVar User Folder"
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "ReVar App Folder"
LangString LNKFORUPDATER ${LANG_ENGLISH} "ReVar Check for Updates"
LangString LNKFORSETUP ${LANG_ENGLISH} "ReVar Installation Preference"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall ReVar"
...
toquit:
  ...
  ReadRegStr $R0 HKLM "Software\Rime\ReVarInput" "InstallDir"
  StrCmp $R0 "" 0 skip
...
skip:
  ReadRegStr $R0 HKLM \
  "Software\Microsoft\Windows\CurrentVersion\Uninstall\ReVarInput" \
  "UninstallString"
  StrCmp $R0 "" done
...
uninst:
  ...
  ReadRegStr $R1 HKLM SOFTWARE\Rime\ReVarInput "WeaselRoot"
...
call_uninstaller:
  ...
  DeleteRegKey HKLM SOFTWARE\Rime\ReVarInput
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\ReVarInput"
  ...
  ${ElseIf} ${IsNativeAMD64}
    SetRegView 64
  ${Endif}
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "ReVarInputServer"
...
InstallDirRegKey HKLM "Software\Rime\ReVarInput" "InstallDir"
...
Section "ReVar Input"
  ...
  ; ReVar is a system-wide TSF text service.  On x64 Windows, keep HKLM
  ; install/uninstall state in the native 64-bit registry view instead of
  ; WOW6432Node, otherwise Windows Settings and service discovery become
  ; inconsistent.
  ${If} ${IsNativeARM64}
    SetRegView 64
  ${ElseIf} ${IsNativeAMD64}
  ...
  ; Clean registry leftovers written by earlier experimental x86 NSIS builds.
  ${If} ${RunningX64}
    SetRegView 32
    DeleteRegKey HKLM SOFTWARE\Rime\ReVarInput
    DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\ReVarInput"
  ...
  WriteRegStr HKLM SOFTWARE\Rime\ReVarInput "InstallDir" "$INSTDIR"
...
program_files:
  ...
  ${Endif}
  ; Write autorun key
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "ReVarInputServer" "$INSTDIR\WeaselServer.exe"
  ; Start WeaselServer
  ...
  WriteRegStr HKCU "Software\Rime\ReVarInput\Updates" "CheckForUpdates" "0"
  GoTo end
  EnableAutoCheckUpdate:
  WriteRegStr HKCU "Software\Rime\ReVarInput\Updates" "CheckForUpdates" "1"
  end:
